...
//  SYSCTL_RCGCGPIO_R |= 0x02; //sets bit 1
//
//  //enable clock to UART1
//  SYSCTL_RCGCUART_R = 0x02; //sets bit 1
//
//  //wait for GPIOB and UART1 peripherals to be ready
//  while ((SYSCTL_PRGPIO_R & 0x02) == 0) {}; //Checks to see if bit 1 ready
//  while ((SYSCTL_PRUART_R & 0x02) == 0 ) {}; //Checks to see if bit 1 ready
//
//  //enable alternate functions on port B pins
//  GPIO_PORTB_AFSEL_R |= 0x03; //sets bits 1 and 2 for Rx and Tx
//
//  //enable digital functionality on port B pins
//  GPIO_PORTB_DEN_R |= 0x03; //sets bits 1 and 2 for Rx and Tx
//
//  //enable UART1 Rx and Tx on port B pins
//  GPIO_PORTB_PCTL_R &= 0xFFFFFF00; //clears fields 0 and 1
//  GPIO_PORTB_PCTL_R &= 0x00000011; //sets fields 0 and 1 to 0001
//
//  //calculate baud rate
